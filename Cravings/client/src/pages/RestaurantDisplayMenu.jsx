    ...
    <>
      <div className="bg-gray-100 min-h-screen flex justify-center">
        <div className="w-full max-w-4xl p-6">
          ...
          <button
            onClick={() => navigate(-1)}
            className="mb-4 text-orange-500 font-semibold hover:text-orange-600"
          >
            ← Back
          </button>
            ...
            {restaurantData?.map((item) => (
              ...
              >
                ...
                <div className="flex-1 pr-8">
                  ...
                  {/* Add To Cart Button */}
                  <button
                    className="mt-4 bg-orange-500 text-white px-5 py-2 rounded-xl hover:bg-orange-600 transition disabled:bg-gray-300"
